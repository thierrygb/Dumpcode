...
public class VotoDE extends JFrame {
	...
	VotoDE(){
		...
		texto = new JLabel();
		texto.setText("DEPUTADO ESTADUAL");
		texto.setBounds(5,10,500,30); 
		add(texto);
	...
	public class Acao implements ActionListener{
		public void actionPerformed (ActionEvent event){
				...
				if(event.getSource()== confirmar){
								...
								View.votoDE(campo.getText());
								setVisible(false);
								JOptionPane.showMessageDialog(null, "VOTAÇAO TERMINOU");
				}
		}
	}
}